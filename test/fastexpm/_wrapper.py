...
class ExpMatFloat32:
    ...
    def __init__(self, N: int):
        self.N = N
        self._backend = fastexpm.ExpMatFloat32(N)
...
class ExpMatFloat64:
    ...
    def __init__(self, N: int):
        self.N = N
        self._backend = fastexpm.ExpMatFloat64(N)
...
class ExpMatComplex64:
    ...
    def __init__(self, N: int):
        self.N = N
        self._backend = fastexpm.ExpMatComplex64(N)
...
class ExpMatComplex128:
    ...
    def __init__(self, N: int):
        self.N = N
        self._backend = fastexpm.ExpMatComplex128(N)
